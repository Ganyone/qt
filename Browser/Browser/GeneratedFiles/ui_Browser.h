...
"}"));
        ...
        B_Return->setStyleSheet(QLatin1String("QPushButton:pressed {\n"
"  padding-left:1px;\n"
"    padding-top:2px;\n"
"}\n"
"QPushButton:hover{\n"
...
""));
        ...
        B_Return->setIconSize(QSize(20, 20));
        ...
        B_Forward->setStyleSheet(QLatin1String("QPushButton:pressed {\n"
"  padding-left:1px;\n"
"    padding-top:2px;\n"
"}\n"
"QPushButton:hover{\n"
...
""));
        ...
        B_Forward->setIconSize(QSize(20, 20));
        ...
        sizePolicy1.setHeightForWidth(B_Refresh->sizePolicy().hasHeightForWidth());
        B_Refresh->setSizePolicy(sizePolicy1);
        B_Refresh->setMinimumSize(QSize(0, 10));
        B_Refresh->setStyleSheet(QLatin1String("QPushButton:hover{\n"
"background-color: rgb(136, 136, 136);\n"
"\n"
"}\n"
"\n"
...
"}"));
        ...
        sizePolicy2.setHeightForWidth(LE_wangye->sizePolicy().hasHeightForWidth());
        LE_wangye->setSizePolicy(sizePolicy2);
        LE_wangye->setMinimumSize(QSize(0, 20));
        QFont font;
        ...
        B_load->setMinimumSize(QSize(80, 22));
...
"}"));
        ...
        p_JinDu = new QProgressBar(tab_2);
        p_JinDu->setObjectName(QStringLiteral("p_JinDu"));
        p_JinDu->setStyleSheet(QLatin1String("QProgressBar::chunk {\n"
...
"}"));
        ...
        verticalLayout_2->addWidget(p_JinDu);
