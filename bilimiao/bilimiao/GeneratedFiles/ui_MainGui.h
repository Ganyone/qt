...
public:
    ...
    void setupUi(QDialog *MainGui)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("Resources/1.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        b_pritruce->setIcon(icon);
        b_pritruce->setIconSize(QSize(50, 50));
...
""));
        QIcon icon1;
        icon1.addFile(QStringLiteral("Resources/min.png"), QSize(), QIcon::Normal, QIcon::Off);
        b_min->setIcon(icon1);
...
""));
        QIcon icon2;
        icon2.addFile(QStringLiteral("Resources/close.png"), QSize(), QIcon::Normal, QIcon::Off);
        b_close->setIcon(icon2);
    ...
    void retranslateUi(QDialog *MainGui)
    {
        ...
        pushButton_3->setText(QApplication::translate("MainGui", "\346\220\234\347\264\242", Q_NULLPTR));
        pushButton_5->setText(QApplication::translate("MainGui", "\350\247\206\351\242\221", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("MainGui", "\345\233\276\347\211\207", Q_NULLPTR));
        b_setting->setText(QApplication::translate("MainGui", "\350\256\276\347\275\256", Q_NULLPTR));
        b_pifu->setText(QApplication::translate("MainGui", "\344\270\213\350\275\275", Q_NULLPTR));
        b_Return1->setText(QApplication::translate("MainGui", "\350\277\224\345\233\236", Q_NULLPTR));
        b_Return2->setText(QApplication::translate("MainGui", "\350\277\224\345\233\236", Q_NULLPTR));
